...
| 优先级 | 缺失类型 | 影响 | 数量建议 |
|--------|----------|------|----------|
| **P1 高** | 五大振兴案例库 | 无法提供产业/人才/文化/生态/组织振兴案例 | 10-15 个 |
| **P1 高** | 省级/市县政策 | 仅国家层面政策，缺少地方细节 | 5-10 个 |
| **P2 中** | 失败案例/风险警示 | 无法提供风险预警 | 3-5 个 |
| **P2 中** | 实施方案模板 | 无法提供可复制方案 | 3-5 个 |
| **P3 低** | 技术规范/法律法规 | 缺少标准参考 | 按需补充 |
