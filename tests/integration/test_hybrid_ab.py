...
TEST_QUERIES = [
    # === 保留原有查询（3个）===
    # 关键词精确匹配
    TestQuery("耕地保护政策", "政策", ["耕地", "保护", "红线", "高标准农田"], "easy"),
    # 混合场景
    TestQuery("农业补贴申请流程", "政策", ["补贴", "申请", "农机购置", "最低收购价"], "medium"),
    TestQuery("水稻病虫害防治方法", "技术", ["水稻", "病虫害", "绿色防控", "统防统治"], "hard"),

    # === 新增查询（12个）覆盖新增振兴案例 ===
    # A. 关键词精确匹配场景（BM25应更优）
    TestQuery("千万工程实施经验", "政策", ["千万工程", "示范村", "提档升级", "梯次推进"], "easy"),
    TestQuery("科技特派员制度", "政策", ["科技特派员", "驻村", "第一书记"], "medium"),
    TestQuery("积分制乡村治理", "政策", ["积分制", "寨管家", "网格化", "清单制"], "medium"),
    TestQuery("白羽肉鸡产业链", "技术", ["白羽肉鸡", "产业链", "零废弃", "种养循环"], "medium"),

    # B. 语义相似场景（向量检索应更优）
    TestQuery("片区化振兴模式", "技术", ["片区化", "共富片区", "四联四共", "抱团发展"], "medium"),
    TestQuery("城乡融合发展路径", "政策", ["城乡融合", "山海协作", "县域经济", "多规合一"], "medium"),
    TestQuery("生态产品价值实现", "技术", ["两山转化", "碳林贷", "鄂林碳票", "生态资源"], "hard"),
    TestQuery("智慧农业技术应用", "技术", ["工厂化育秧", "智慧农机", "AI新农具", "数字人"], "hard"),

    # C. 混合场景（混合检索应最佳）
    TestQuery("边疆特色产业振兴", "政策", ["边疆", "民族地区", "骆驼", "沙棘", "特色产业"], "hard"),
    TestQuery("库区农业绿色发展", "技术", ["库区", "绿色农业", "化肥减量", "水质达标"], "medium"),
    TestQuery("村庄分类建设标准", "政策", ["村庄分类", "一类村", "集聚提升类", "城郊融合类"], "medium"),
    TestQuery("乡村人才引进机制", "政策", ["人才引进", "一村一名大学生", "返乡创业"], "medium"),
]
